...
return [(function (){var pred__1869 = cljs.core.instance_QMARK_;
var expr__1870 = reactive_val;
if(cljs.core.truth_(pred__1869.call(null,reagent.ratom.RAtom,expr__1870))){
return "ra";
} else {
if(cljs.core.truth_(pred__1869.call(null,reagent.ratom.RCursor,expr__1870))){
return "rc";
} else {
if(cljs.core.truth_(pred__1869.call(null,reagent.ratom.Reaction,expr__1870))){
return "rx";
} else {
if(cljs.core.truth_(pred__1869.call(null,reagent.ratom.Track,expr__1870))){
return "tr";
} else {
return "other";
}
