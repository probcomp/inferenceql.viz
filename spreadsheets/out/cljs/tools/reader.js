...
var G__4654 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4654;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4655 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4655,ch);
...
if(("\\" === ch__$1)){
var ch_4656__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4656__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4656__$2);
} else {
}

var G__4657 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4657;
continue;
}
}
...
var vec__4665 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4665,(0),null);
var start_column = cljs.core.nth.call(null,vec__4665,(1),null);
...
var G__4668 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4668;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4669 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4670 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4670;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4669;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4671 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4671,(0),null);
var start_column = cljs.core.nth.call(null,vec__4671,(1),null);
...
var vec__4674 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4674,(0),null);
var end_column = cljs.core.nth.call(null,vec__4674,(1),null);
...
var vec__4677 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4677,(0),null);
var start_column = cljs.core.nth.call(null,vec__4677,(1),null);
...
var vec__4680 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4680,(0),null);
var end_column = cljs.core.nth.call(null,vec__4680,(1),null);
...
var vec__4683 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4683,(0),null);
var start_column = cljs.core.nth.call(null,vec__4683,(1),null);
...
var vec__4686 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4686,(0),null);
var end_column = cljs.core.nth.call(null,vec__4686,(1),null);
...
var sb = (function (){var G__4689 = (new goog.string.StringBuffer());
G__4689.append(initch);
...
var G__4691 = (function (){var G__4690 = sb;
G__4690.append(ch);
...
switch (G__4695) {
case "\\":
var G__4699 = (function (){var G__4696 = sb;
G__4696.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4696;
})();
var G__4700 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4699;
ch = G__4700;
continue;
...
break;
default:
var G__4701 = (function (){var G__4697 = sb;
G__4697.append(ch);

return G__4697;
})();
var G__4702 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4701;
ch = G__4702;
continue;
...
var vec__4703 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4703,(0),null);
var end_column = cljs.core.nth.call(null,vec__4703,(1),null);
...
var vec__4706 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4706,(0),null);
var column = cljs.core.nth.call(null,vec__4706,(1),null);
...
var vec__4711 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4711,(0),null);
var column = cljs.core.nth.call(null,vec__4711,(1),null);
...
var vec__4716 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4716,(0),null);
var column = cljs.core.nth.call(null,vec__4716,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4721 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4721,(0),null);
var start_column = cljs.core.nth.call(null,vec__4721,(1),null);
...
var vec__4724 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4724,(0),null);
var end_column = cljs.core.nth.call(null,vec__4724,(1),null);
...
var G__4727 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4727,true,null,opts,pending_forms);
...
var G__4728 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4728)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4728)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4728)){
...
var _STAR_suppress_read_STAR__orig_val__4729 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4730 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4730;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4729;
}});
...
var G__4731 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4731,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4731,rdr,first_line);
...
var G__4735 = matched;
var G__4736 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4735;
finished = G__4736;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4737 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4738 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4738;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4737;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4739 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4740 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__4740;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4741 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4741,"(");
...
var G__4742 = (i + (1));
var G__4743 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__4739;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4744 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4744);
...
var G__4747 = cljs.core.next.call(null,s);
var G__4748 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4747;
key_vals = G__4748;
continue;
} else {
...
var gensym_env_orig_val__4752 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4753 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__4753;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__4752;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4754 = token;
var G__4754__$1 = (((G__4754 == null))?null:cljs.core.subs.call(null,G__4754,(1)));
var G__4754__$2 = (((G__4754__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4754__$1));
var G__4754__$3 = (((G__4754__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4754__$2));
var G__4754__$4 = (((G__4754__$3 == null))?null:cljs.core.symbol.call(null,G__4754__$3));
if((G__4754__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4754__$4);
}
})():(function (){var G__4755 = token;
var G__4755__$1 = (((G__4755 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4755));
if((G__4755__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4755__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e4762){if((e4762 instanceof Error)){
var e = e4762;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4766,reader){
...
var opts = map__4767__$1;
var eof = cljs.core.get.call(null,map__4767__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
