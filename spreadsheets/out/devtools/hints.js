...
var map__21346 = top_item;
var map__21346__$1 = (((((!((map__21346 == null))))?(((((map__21346.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21346.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21346):map__21346);
var file = cljs.core.get.call(null,map__21346__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21346__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21346__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5718__auto___21348 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___21348)){
var seen_errors_21349 = temp__5718__auto___21348;
if(cljs.core.truth_(seen_errors_21349.has(self))){
} else {
seen_errors_21349.add(self);

var temp__5720__auto___21350 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___21350)){
var sense_21351 = temp__5720__auto___21350;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21351)].join('');
} else {
}
}
} else {
