...
var G__20582 = devtools.prefs.pref.call(null,v);
v = G__20582;
continue;
} else {
return v;
...
}catch (e20585){var _e__19594__auto__ = e20585;
return false;
}})();
...
}catch (e20589){var _e__19594__auto__ = e20589;
return false;
}})();
...
}catch (e20591){var _e__19594__auto__ = e20591;
return false;
}}
}
});
...
var vec__20593 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20593,(0),null);
var name = cljs.core.nth.call(null,vec__20593,(1),null);
...
return cljs.core.some.call(null,(function (p1__20596_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20596_SHARP_);
}),template);
});
