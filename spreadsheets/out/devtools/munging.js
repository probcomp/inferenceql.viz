...
var o20477 = temp__5718__auto__;
var temp__5718__auto____$1 = (o20477["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o20478 = temp__5718__auto____$1;
return (o20478["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19587__auto__ = f;
return (o__19587__auto__["toString"]).call(o__19587__auto__);
} else {
return "";
}
}catch (e20479){var _ = e20479;
return "";
}});
...
try{var o__19587__auto___20481 = t;
(o__19587__auto___20481["cljs$lang$ctorPrWriter"]).call(o__19587__auto___20481,t,writer);
}catch (e20480){var __20482 = e20480;
}
...
var char_code = (function (){var o__19587__auto__ = (new String(char$));
return (o__19587__auto__["charCodeAt"]).call(o__19587__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19587__auto__ = String;
return (o__19587__auto__["fromCharCode"]).call(o__19587__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20483 = num_code;
switch (G__20483) {
case (1):
return (185);
...
var o__19587__auto__ = String;
return (o__19587__auto__["fromCharCode"]).call(o__19587__auto__,superscript_code);
});
/**
...
}catch (e20485){var _e__19594__auto__ = e20485;
return false;
}})())){
...
var vec__20486 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20486,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o20489 = temp__5718__auto__;
var temp__5718__auto____$1 = (o20489["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o20490 = temp__5718__auto____$1;
return (o20490["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20493){
var vec__20494 = p__20493;
var ns_detector = cljs.core.nth.call(null,vec__20494,(0),null);
...
var G__20500 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20501 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20500;
remaining_tokens = G__20501;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20491){
var G__20492 = cljs.core.first.call(null,seq20491);
var seq20491__$1 = cljs.core.next.call(null,seq20491);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20492,seq20491__$1);
});
...
var vec__20505 = cljs.core.split_with.call(null,(function (p1__20504_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20504_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20505,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20505,(1),null);
...
var vec__20511 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20511,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20511,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20514 = cljs.core.rest.call(null,remaining_tokens);
var G__20515 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20514;
name_tokens = G__20515;
continue;
} else {
...
var vec__20518 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20518,(0),null);
var arity = cljs.core.nth.call(null,vec__20518,(1),null);
var vec__20521 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20521,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20521,(1),null);
var vec__20524 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20524,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20524,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20524,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20524,(3),null);
...
var vec__20530 = result;
var munged_ns = cljs.core.nth.call(null,vec__20530,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20530,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20530,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20530,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20530,(4),null);
var arity = cljs.core.nth.call(null,vec__20530,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__20534 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__20534,(0),null);
var args = cljs.core.nth.call(null,vec__20534,(1),null);
var vec__20537 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20537,(0),null);
var name = cljs.core.nth.call(null,vec__20537,(1),null);
...
var G__20540 = (arity + (1));
var G__20541 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20542){
var vec__20543 = p__20542;
var arity = cljs.core.nth.call(null,vec__20543,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20543,(1),null);
...
return cljs.core.get.call(null,arities,p1__20546_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20547_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20550){
var vec__20551 = p__20550;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20551,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20548){
var G__20549 = cljs.core.first.call(null,seq20548);
var seq20548__$1 = cljs.core.next.call(null,seq20548);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20549,seq20548__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__20559__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20559__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20559__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20559__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20560 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20560,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20560,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20560,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20560,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20560,(4),null);
var arity = cljs.core.nth.call(null,vec__20560,(5),null);
...
var o__19587__auto__ = f;
return (o__19587__auto__["getBasis"]).call(o__19587__auto__);
});
/**
...
}catch (e20564){var _e__19594__auto__ = e20564;
...
var G__20565 = (obj[cljs.core.first.call(null,path)]);
var G__20566 = cljs.core.rest.call(null,path);
obj = G__20565;
path = G__20566;
continue;
} else {
...
return (function (accum,p__20567){
var vec__20568 = p__20567;
var bit = cljs.core.nth.call(null,vec__20568,(0),null);
var protocol = cljs.core.nth.call(null,vec__20568,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20571){
var vec__20572 = p__20571;
var ns = cljs.core.nth.call(null,vec__20572,(0),null);
var name = cljs.core.nth.call(null,vec__20572,(1),null);
var selector = cljs.core.nth.call(null,vec__20572,(2),null);
...
return (function (p__20576){
var vec__20577 = p__20576;
var munged_name = cljs.core.nth.call(null,vec__20577,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20577,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20577,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20575_SHARP_){
return (obj[cljs.core.first.call(null,p1__20575_SHARP_)]);
});})(name,sorted_matches,vec__20577,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
